 ...
 *****************************************************************************/
#define     IS_VALID_CH(x)          (DtChannel1 ==(x)||DtChannel2 == (x) )
#define     IS_VALID_MODE(x)        (   DtModeFreeRun == (x) || \
                                        DtModeOneShot == (x) || \
                                        DtModePeriodic == (x) )

#define     IS_VALID_PRESCALER(x)   (DtPrescalerDiv1 == (x) ||\
                                     DtPrescalerDiv16 == (x) ||\
                                     DtPrescalerDiv256 == (x) )
 ...
 *****************************************************************************/
/// Look-up table for all DT instances
 ...
 **
 ** \retval     stc_dt_instance_data_t    Pointer to a Instance  data
...
en_result_t Dt_Init(uint8_t u8ch, stc_dt_channel_config_t *pstcConfig)
{
    ...
    pstcDt->TIMERCTRL = 0u;              /* Disable everything */
