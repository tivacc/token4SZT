...
unsigned char des_key[16],des_key_temp[8];
...
//key: 16位密钥
//data_out: MAC 码
//initdata-initial data for MAC,insdata-CLA,INS...must be devide by 8;dataout-result of MAC;
...

{
    ...
    unsigned char len;
    unsigned char i,j;    unsigned char L[8],R[8];
